...
\usepackage{textgreek} % oppure \usepackage{upgreek}
...
\input{Capitoli/Project description}
\input{Capitoli/Implementation}
\input{Capitoli/Problems and Solution.tex}
\input{Capitoli/Results and Evaluation}
