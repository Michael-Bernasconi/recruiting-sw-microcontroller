...
Originally, the project intended the use of a \textbf{Hall sensor} for both analog and digital readings. However, due to a malfunction of the sensor, it was replaced with a \textbf{potentiometer} for analog readings and a button for digital readings.
